...
import { Barcode, LayoutDashboard, Package, ShoppingBag, Tags, Ticket } from "lucide-react";
...
const NAV_FULL = [
  ...
  { href: "/admin/bodega", label: "Bodega", icon: Barcode },
];

const NAV_WAREHOUSE = [{ href: "/admin/bodega", label: "Bodega", icon: Barcode }];
...
export default async function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const nav = role === "WAREHOUSE" ? NAV_WAREHOUSE : NAV_FULL;
